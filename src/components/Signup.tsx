...
export default function SignupPage() {
  ...
  const signInWith=(strategy:OAuthStrategy)=>{
    return signUp?.authenticateWithRedirect({
      redirectUrl:'/sign/sso-callback',
      strategy:strategy,
      redirectUrlComplete:'/dashboard'
    })
    .then((res)=>{
      console.log("Oauth resp is",res)
    })
    .catch((e)=>{
      console.log(e);
    }
      ...
      <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
        ...
        {!verify ? (
          ...
          <form className="my-8" onSubmit={handleVerify}>
            ...
            <button
              className="group/btn relative block h-10 w-full rounded-md bg-gradient-to-br from-black to-neutral-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset] mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
              type="submit"
            ...
            <button
              type="button"
              className="mt-4 text-sm text-neutral-600 dark:text-neutral-300 hover:text-neutral-800 dark:hover:text-neutral-100"
